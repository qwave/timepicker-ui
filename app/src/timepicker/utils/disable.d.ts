...
export declare const checkDisabledHoursAndMinutes: (value: (string | number)[] | string | number | undefined, type: 'hour' | 'minutes', clockType?: OptionTypes['clockType'], allowNull?: OptionTypes['allowNull'], arrValue?: (string | number)[]) => boolean | undefined;
